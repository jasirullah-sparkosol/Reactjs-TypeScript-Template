...
// types
import { MockTableDataProps } from 'types/table';
...
export default function DraggableColumnHeader({
    ...
    header: Header<MockTableDataProps, unknown>;
    table: Table<MockTableDataProps>;
    ...
    const [{ isOverCurrent }, dropRef]: any = useDrop({
        accept: 'column',
        drop: (draggedColumn: Column<MockTableDataProps>) => {
    ...
    const [{ isDragging }, dragRef, previewRef]: any = useDrag({
        collect: (monitor) => ({
